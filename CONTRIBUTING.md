Thank you for your interest in contributing to `http3`. All important information is below.

# Duvet
The [`duvet`][] crate is used in `http3` to track [spec][] compliance.
...
[report]: https://0x676e67.github.io/http3/ci/compliance/report.html#/
